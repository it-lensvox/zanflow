...
_cors_origins = config(
    ...
    default="http://localhost:3001,http://localhost:3000,http://127.0.0.1:5173,http://192.168.1.121:5173,http://192.168.1.7:3001,http://192.168.1.160:3001,http://192.168.1.164:3001, http://192.168.1.188:8000"
)
