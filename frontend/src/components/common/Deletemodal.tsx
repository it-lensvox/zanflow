  ...
  if (type === 'denied') {
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center animate-in fade-in duration-200">
        ...
        {/* Modal */}
        <div className="relative bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 animate-in zoom-in-95 duration-200">
          {/* Warning Icon */}
         ...
         <p className="text-muted-foreground text-center mb-8">
            Only the <span className="font-semibold text-foreground">person who created it</span> can delete it.
          </p>
