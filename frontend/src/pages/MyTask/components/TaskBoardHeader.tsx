  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3" style={{ marginBottom: 16 }}>
        ...
        {canCreate && (
          <div className="flex items-center gap-2 flex-wrap" style={{ paddingTop: 4 }}>
            <button onClick={onAITask} style={{ height: 40, display: 'flex', alignItems: 'center', gap: 8, padding: '0 18px', border: `1px solid ${LINE}`, borderRadius: 8, background: 'hsl(var(--muted))', cursor: 'pointer', fontSize: 16, fontWeight: 600, color: TEXT, whiteSpace: 'nowrap' }}>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        <div style={{ flex: 1, minWidth: 0, height: 40, background: 'hsl(var(--input))', border: `1px solid ${LINE}`, borderRadius: 8, display: 'flex', alignItems: 'center', padding: '0 12px', gap: 10 }}>
